...
import time
from src.db_functions import listar_residencias, obter_condominio_por_cnpj, deletar_residencia, login_sessao
...
with st.container(height=500, border=True):
    ...
    for residencia in residencias:
        ...
        with st.container(border=True):
            ...
            c_icon.image("./src/Interface/img/apt.png", width=70)
