...
import time
from src.db_functions import obter_residencia_por_id,listar_moradores_residencia, listar_moradores_residencia, deletar_morador, login_sessao
...
with st.container(height=500, border=True):
    ...
    for morador in moradores:
        ...
        with st.container(border=True):
            ...
            c_icon, c_info, c_veic, c_edit, c_del = st.columns(
                [0.7, 4, 0.7, 0.7, 0.7],
