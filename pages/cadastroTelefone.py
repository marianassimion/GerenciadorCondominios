...
import time
from src.db_functions import login_sessao, criar_telefone, obter_morador_por_id

st.set_page_config(page_title="Novo Telefone", layout="centered")

login_sessao()

if 'morador_telefone' not in st.session_state:
    st.warning("Selecione um morador.")
    st.stop()
    
cpf_morador = st.session_state.morador_telefone
