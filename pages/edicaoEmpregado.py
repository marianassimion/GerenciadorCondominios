...
import time
from src.db_functions import obter_empregado_por_cpf, atualizar_empregado, obter_historico_salarios

st.set_page_config(page_title="Editar Empregado", layout="centered")
...
if dados:
    ...
    with st.form("form_editar_empregado"):
        ...
        # Histórico das Alterações de Salário
        st.divider()
